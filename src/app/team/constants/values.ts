export const teamValues = [
  {
    title: 'Freedom',
    highlight: 'Freedom',
    subtitle: ': Where innovation starts',
    description:
      "We believe the best solutions come from pushing limits. Our team thrives on experimentation, unconventional ideas, and testing what's never been done before - so your product stands out, not blends in.",
    image: '/images/values/freedom.png',
  },
  {
    title: 'Communication',
  ...
  },
  {
    ...
    subtitle: ': Built to evolve with you',
    description:
      'Markets change. Tech evolves. So do we. We pivot fast, adapt faster, and stay aligned with your needs as your product grows.',
    image: '/images/values/adaptation.png',
  },
]
