export const faqData = [
  ...
  {
    question: "How long does it take to build a Web3 MVP?",
  ...
  },
  {
    ...
    answer: "Depending on the features and architecture, we prepare a cost estimation and development plan to bring your idea to life and validate it in the market. Without scope clarity, costs start at € 10,000 and can exceed € 100,000. Pricing factors include feature complexity, technology stack, UI/UX design effort, third-party integrations, backend infrastructure requirements, security and compliance needs, team composition, development timeline, testing and QA scope, and project management overhead."
  },
  {
  ...
  },
  {
    ...
    answer: "During our discovery phase, we help you identify the core problem and must-have features. The goal is to build only what you need to validate and then scale based on real-world feedback."
  }
]
