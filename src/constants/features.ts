...
const features = [
  ...
  },
  {
    ...
    description:
      'You just know you must be doing something right when the Ethereum Foundation takes notice. We are constantly looking for ways to exceed the highest standards in blockchain innovation.',
  },
  {
    icon: TvlIcon,
    title: '$100M+ TVL',
